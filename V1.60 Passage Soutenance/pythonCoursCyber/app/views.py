...
#mes routes
@app.route('/set_session/<value>', methods=['GET'])
def route_session(value):
    return models.set_session(value)
...
def supprimer_commande():
    return models.supprimer_commande()

@app.route('/ajouter_commande', methods=['POST'])
def ajouter_commande():
    return models.ajouter_commande()

@app.route('/services', methods=['GET'])
def services():
    return models.services_page()
